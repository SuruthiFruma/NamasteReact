...
const Body = () => {
    ...
    //Calling HighereOrder Components
        ...
        (
            <div className="body ">
                <div className="flex">
                    ...
                    {/* UserName Input Box */}
                    <div className="m-4 py flex items-center">
          ...
          <Restaurant resData={restaurantList[7]} ></Restaurant> */}
                    ...
                    {filteredRestaurants.map((res, index) => {
                        ...
                        return <Link to={"/restaurant/" + res.info.id} key={res.info.id}>
                              { (res.info.promoted)?
                                <RestaurantPromoted resData={res.info}></RestaurantPromoted>:
                             
                               <Restaurant resData={res.info}></Restaurant>}
                               </Link>
